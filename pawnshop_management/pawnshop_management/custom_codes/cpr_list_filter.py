...
def filter_cpr_based_on_banch(user):
    ...
    if str(current_ip) == str(branch_ip['cavite_city']) and (user_role.role_profile_name == "Cashier" or user_role.role_profile_name == "Supervisor/Cashier" or user_role.role_profile_name == "Appraiser/Cashier" or user_role.role_profile_name == "Appraiser" or user_role.role_profile_name == "Supervisor"):
        return "(`tabCash Position Report`.branch = 'Garcia''s Pawnshop - CC')"
        ...
        return "(`tabCash Position Report`.branch = 'Garcia''s Pawnshop - POB')"
        ...
        return "(`tabCash Position Report`.branch = 'Garcia''s Pawnshop - MOL')"
        ...
        return "(`tabCash Position Report`.branch = 'Garcia''s Pawnshop - GTC')"
        ...
        return "(`tabCash Position Report`.branch = 'Garcia''s Pawnshop - TNZ')"
        ...
        return "(`tabCash Position Report`.branch = 'Rabie''s House')"
