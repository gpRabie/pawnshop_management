...
def filter_j_based_on_banch(user):
    ...
    if str(current_ip) == str(branch_ip['cavite_city']) and (user_role.role_profile_name == "Cashier" or user_role.role_profile_name == "Supervisor/Cashier" or user_role.role_profile_name == "Appraiser/Cashier" or user_role.role_profile_name == "Appraiser" or user_role.role_profile_name == "Supervisor"):
        return "(`tabPawn Ticket Jewelry`.branch = 'Garcia''s Pawnshop - CC')"
        ...
        return "(`tabPawn Ticket Jewelry`.branch = 'Garcia''s Pawnshop - POB')"
        ...
        return "(`tabPawn Ticket Jewelry`.branch = 'Garcia''s Pawnshop - MOL')"
        ...
        return "(`tabPawn Ticket Jewelry`.branch = 'Garcia''s Pawnshop - GTC')"
        ...
        return "(`tabPawn Ticket Jewelry`.branch = 'Rabie''s House')"
