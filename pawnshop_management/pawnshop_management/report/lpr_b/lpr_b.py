...
def execute(filters=None):
	columns, data = [], []
	columns = get_columns()
	data = frappe.get_all("Provisional Receipt", filters={'pawn_ticket_no': ['like', '%B%'], 'docstatus': 1}, fields=['date_issued', 'complete_name', 'pawn_ticket_no', 'principal_amount', 'interest_payment'])
