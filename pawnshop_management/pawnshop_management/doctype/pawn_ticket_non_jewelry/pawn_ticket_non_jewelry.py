...
class PawnTicketNonJewelry(Document):
	...
	def on_submit(self):
		if frappe.db.exists('Non Jewelry Batch', self.inventory_tracking_no) == "" or frappe.db.exists('Non Jewelry Batch', self.invetory_tracking_no) == None:	#Copies Items table from pawnt ticket to non jewelry batch doctype
